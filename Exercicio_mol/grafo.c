...
char vertice_elemento(vertice v){
  return v->elemento;
}
...
void adiciona_vertice(int id, char elemento, grafo G) {
...
void imprime_grafo(grafo G) {
  printf("\nVertices: elemento <id> - [grau]( <fronteira> )");
  printf("\nVertices: ");
...
void imprime_vertice(vertice v) {
  printf("%c %d - [%d]( ", vertice_elemento(v), vertice_id(v), grau(v));
