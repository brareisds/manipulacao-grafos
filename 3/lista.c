...
//-------------------------------------------------------------------
// funcao adicionada como parte do exercicio 3:

// destroi a lista de diferentes tipos de objetos
// [a funcao <destroi_objeto(c)> deve destruir o conteudo de c]
void destroi_lista(lista l, void (*destroi_conteudo)(obj c), int f_chave(obj c)) {
    if (l == NULL) return;
    ...
    free(l); // libera a lista depois de esvaziá-la.
    l = NULL;
}
